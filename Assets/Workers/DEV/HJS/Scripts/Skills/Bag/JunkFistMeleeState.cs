...
public class JunkFistMeleeState : BaseState<PlayerController>
{
    ...
    public JunkFistMeleeState(PlayerController owner)
    {
        this.owner = owner;
        type = EState.Melee;
        ...
        {
            meleeAnimHashes[i] = Animator.StringToHash($"JunkFistMelee{i + 1}");
        }
    }
